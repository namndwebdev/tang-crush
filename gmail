...
<html lang="en">
  <head>
    ...
    <title>Hệ thống AUTO Gmail Dinh Fap</title>
  ...
  <body>
    <noscript>
      <strong>We're sorry but Hệ thống AUTO Gmail Dinh Fap doesn't work properly without JavaScript enabled. Please enable it to continue.</strong>
    </noscript>
    <div id="app"></div>
